  ...
  <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
      <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
        <div class="d-flex align-items-center">
          <div class="d-block">
             <h2 class="h5 mb-3">Hallo, <?php echo $username ?? 'Benutzer'; ?></h2>
        ...
        <li class="nav-item">
          <a href="/sensors" class="nav-link">
            <span class="sidebar-icon">
             ...
             <span class="sidebar-text">Sensoren</span>
          </a>
        </li>

        <li class="nav-item">
          <a href="/sensortypes" class="nav-link">
            <span class="sidebar-icon">
              <i class="bi bi-tags"></i>
            </span>
             <span class="sidebar-text">Sensortypen</span>
          </a>
        </li>
              ...
              <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button"
                ...
                <div class="media d-flex align-items-center">
                  ...
                  <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                    <span class="mb-0 font-small fw-bold text-gray-900"><?php echo $username ?? 'User'; ?></span>
                  </div>
                </div>
              </a>
